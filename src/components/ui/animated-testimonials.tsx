...
export const AnimatedTestimonials = ({
    ...
    // Generate fixed random rotations once after mount
    useEffect(() => {
    ...
    return (
        <div className={cn("max-w-sm md:max-w-4xl mx-auto px-4 md:px-8 lg:px-12 py-20", className)}>
            <div className="relative grid grid-cols-1 md:grid-cols-2 gap-20">
                ...
                {/* Text & Arrows */}
                <div className="relative flex flex-col justify-between py-4 z-20">
                    <motion.div
                        key={active}
                    ...
                    <div className="absolute bottom-0 right-0 mt-4 flex gap-4">
                        <button
                            onClick={handlePrev}
                            className="h-8 w-8 rounded-full bg-secondary flex items-center justify-center group/button focus:outline-none"
                        >
