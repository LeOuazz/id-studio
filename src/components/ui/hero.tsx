...
export function Hero() {
    const words = "Our Lead Dev's Portfolio".split(" ")


    return (
        <section id="portfolio" className="relative min-h-screen w-full flex items-center justify-center overflow-hidden bg-white dark:bg-neutral-950">
            {/* Floating SVG lines */}
